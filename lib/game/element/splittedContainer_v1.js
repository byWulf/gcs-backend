...
function SplittedContainer(data) {
    ...
    this.setRows = function(newRows) {
        ...
        if (newRows.reduce(function(a, b) { return a + b; }, 0) !== 1.0) throw new Error('SplittetContainer_v1.rows elements must be in sum exactly 1.');
    ...
    this.setColumns = function(newColumns) {
        ...
        if (newColumns.reduce(function(a, b) { return a + b; }, 0) !== 1.0) throw new Error('SplittetContainer_v1.columns elements must be in sum exactly 1.');
