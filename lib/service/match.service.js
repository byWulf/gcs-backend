...
module.exports = new (function() {
    ...
    this.startMatch = function(matchId, socketId) {
        ...
        console.log(match.masterUserId);
        console.log(user.id);
        console.log(match.masterUserId == user.id);
        console.log(match.masterUserId === user.id);
        console.log(typeof match.masterUserId);
        console.log(typeof user.id);
        console.log(JSON.stringify(match.masterUserId));
