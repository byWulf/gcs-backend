module.exports = new (function() {
    ...
    this.registerEvents = function(eventEmitter) {
         ...
         * }}
         */
        eventEmitter.on('newsGetList', function(user, data) {
            user.sendCommand('newsList', self.getList(data.items, data.page));
        });
         ...
         * }}
         */
        eventEmitter.on('newsGetDetail', function(user, data) {
         ...
         * -none-
         */
        eventEmitter.on('newsLike', function(user, data) {
         ...
         * -none-
         */
        eventEmitter.on('newsUnlike', function(user, data) {
